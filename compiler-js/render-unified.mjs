...
<body>
  ...
  <div class="render-info">
    ...
    <p><strong>Styling:</strong> derived from the ODD — the inlined
      <code>edition.css</code> generated by <code>odd-to-css.mjs</code>, plus
      per-element rules the handlers resolve at build time.</p>
    <p><strong>Notes collected:</strong> ${notes.length}</p>
  </div>
